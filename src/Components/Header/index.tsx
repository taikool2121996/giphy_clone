...
// saga
import { requestSearchRequest } from '@/store/reducers/searchRequest/searchRequest.slice';
// hooks
...
const search = <i className="fa fa-search" aria-hidden="true"></i>;

const Header: FC<HeaderProps> = ({ setRendered }) => {
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    dispatch(requestSearchRequest({ q: query }));
